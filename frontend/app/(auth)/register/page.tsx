  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error(data.detail || 'Registrasi gagal')
      }
    } catch (error) {
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:p-10">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              {password.length > 0 && (
                <p
                  className={`mt-1.5 flex items-center gap-1 text-xs transition-colors duration-300 ${
            ...
            <div>
              ...
              {confirmPassword.length > 0 && (
                ...
                >
                  {isPasswordMatch && <Check className="h-3 w-3" />}
